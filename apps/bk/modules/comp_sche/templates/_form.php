...
function change_hour(idx, ctrl){
  ...
  if(idx.match(/companion_.*_hour/i))
  {
    ...
    else if((objhr.selectedIndex == 18 || objhr.selectedIndex == 17) && objm.selectedIndex != 1)
    {
      objm.options[1].selected = true;
    }
  }
    ...
    <tfoot>
      <tr>
        <td colspan="2">
          ...
          &nbsp;<a href="<?php echo url_for('comp_sche/index?shop_id='.$Shop_id) ?>">一覧に戻る</a>
<!--
          <?php if (!$form->getObject()->isNew()): ?>
...
-->
  ...
  <div id="picbox" class="clearfix">
    <div class="pic">
      <?php echo $form['pic1']->renderError() ?><br />
      <?php echo $form['pic1']->renderRow() ?>
    </div>
    <div class="pic">
      <?php echo $form['pic2']->renderError() ?><br />
      <?php echo $form['pic2']->renderRow() ?>
    </div>
    <div class="pic">
      <?php echo $form['pic3']->renderError() ?><br />
      <?php echo $form['pic3']->renderRow() ?>
    </div>
    <div class="pic">
      <?php echo $form['pic4']->renderError() ?><br />
      <?php echo $form['pic4']->renderRow() ?>
    </div>
    <div class="pic">
      <?php echo $form['pic5']->renderError() ?><br />
